...
export const en: typeof ru = {
  ...
  import: {
    ...
    pageDescription: 'Import bank statements',
    historyTitle: 'Import History',
    dialogTitle: 'Import Bank Statement',
    importButton: 'Import Statement',
    dropzoneText: 'Drop file here or click to select',
    supportedFormats: 'Supported formats: CSV, XML',
    ...
    noImports: 'No import history',
    unknownAccount: 'Unknown account',
    transactionsCount: '{{count}} transactions',
    confirmDeleteImport: 'Delete import record?',
    deleteImport: 'Delete',
  },
  ...
  accountEdit: {
    ...
    swiftCodeHelp: 'First 6 characters of SWIFT/BIC (e.g. INSJAM)',
    bankAccountNumber: 'Account Number',
    bankAccountNumberHelp: 'For automatic matching during import',
  ...
  accountSettings: {
    ...
    sections: {
      ...
      loanDeposit: 'Loan/Deposit Settings',
    },
    types: {
      cash: 'Cash',
      card: 'Card',
    ...
    fields: {
      ...
      archive: 'Archived',
      private: 'Private',
      inBalance: 'Include in Balance',
      savings: 'Savings',
      enableCorrection: 'Auto Balance Correction',
      swiftCode: 'Bank SWIFT Code',
      swiftCodeHint: 'First 6 characters (e.g. INSJAM)',
      bankAccountNumber: 'Account Number',
      syncedOnline: 'Online Sync',
      syncedHint: 'Configure in ZenMoney app',
      company: 'Bank',
    ...
    noImports: 'No imports for this account',
    save: 'Save',
  },
  ...
  transaction: {
    ...
    originalPayeeHint: 'Name from bank statement',
  },
  ...
  transactionEditor: {
    ...
    debt: {
      lend: 'Lend',
      getRepayment: 'Get repayment',
      borrow: 'Borrow',
      repayDebt: 'Repay debt',
      debtor: 'Debtor',
      account: 'Account',
      amount: 'Amount',
      currentBalance: 'Balance with {{name}}',
      theyOweYou: 'they owe you',
      youOweThem: 'you owe them',
    },
    transfer: {
      linkTitle: 'Link as transfer',
      selectTransaction: 'Select a transaction to link',
    ...
    advanced: {
      ...
      originalIncome: 'Original income amount',
      originalOutcome: 'Original outcome amount',
      reminder: 'Reminder',
      copied: 'Copied!',
    },
  },
  ...
  filterDrawer: {
    ...
    type_incomeDebt: 'Debt Repayment',
    type_outcomeDebt: 'Debt',
    accounts: 'Accounts',
    accountType_cash: 'Cash',
    accountType_card: 'Cards',
